...
#define SDA_PIN D2        // GPIO4 - I2C SDA for BMP180 and BH1750
#define SCL_PIN D1        // GPIO5 - I2C SCL for BMP180 and BH1750
...
const char* station_id = "WEMOS_STATION_001";
...
void ICACHE_RAM_ATTR rainPulseISR();

void setup() {
  Serial.begin(115200);
  Serial.println("WEMOS D1 R2 Weather Station Starting...");
  ...
  Serial.println("WEMOS Weather Station Ready!");
...
void readAndSendData() {
  ...
  // Read MQ7 (Carbon Monoxide)
  if (sensors.mq7_available) {
    int mq7_raw = analogRead(MQ7_PIN);
    float mq7_voltage = (mq7_raw / 1024.0) * 3.3;
